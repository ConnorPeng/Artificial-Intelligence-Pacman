...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        all_belief = self.beliefs

        for beli in all_belief:
            emission = self.getObservationProb(observation, pac_pos, beli, self.getJailPosition())
            all_belief[beli] = all_belief[beli] * emission
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            newPosDist = self.getPositionDistribution(gameState, oldPos)
            for p in newPosDist:
                new_belief[p] = new_belief[p] + newPosDist[p] * all_belief[oldPos]
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        for i in range(particle):
            self.particles.append(legal[i % n])
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for i in particles:
            tmp[i] = tmp[i] + self.getObservationProb(observation, gameState.getPacmanPosition(), i, self.getJailPosition())
    ...
    def elapseTime(self, gameState):
        ...
        for i in partic:
            ...
            newPosDist_sample = newPosDist.sample()
            distribution.append(newPosDist_sample)
